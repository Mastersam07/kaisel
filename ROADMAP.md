...
kaisel is a Dart 3-native router built on sealed routes, exhaustive pattern matching, and a stack-as-value model. The thinking behind that design — why a route is a value, not a string — is laid out in [Flutter Routes as Values](https://medium.com/@codefarmer/flutter-routes-as-values-089476ad4d5b). This roadmap outlines where the project stands, what's under consideration, and what's intentionally out of scope.
