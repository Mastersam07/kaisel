// Nested modal flows demo for the gate router.
//
...
final class PaymentFlow extends AppRoute implements GateModalRoute<bool> {
...
final class AddCardFlow extends AppRoute implements GateModalRoute<String> {
  const AddCardFlow();
}
