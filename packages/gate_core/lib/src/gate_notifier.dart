...
///
/// gate_core has no Flutter dependency, so it can't expose Flutter's
/// `Listenable`. The Flutter layer (`GateRouterDelegate`,
/// `GateInnerNavigator`, shells) registers `void Function()` callbacks;
/// Flutter's `VoidCallback` is exactly `void Function()`, so these
/// interoperate transparently with the framework.
abstract class GateListenable {
...
class GateChangeNotifier implements GateListenable {
