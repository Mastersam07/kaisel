...
void main() {
  ...
  group('KaiselNavigator interface', () {
    test('KaiselRouter implements KaiselNavigator', () {
      final r = KaiselRouter<_HomeRoute>(initial: const _HomeRoot());
      addTearDown(r.dispose);
      expect(r, isA<KaiselNavigator>());
      // Non-generic ops are reachable via the interface:
      final KaiselNavigator n = r;
