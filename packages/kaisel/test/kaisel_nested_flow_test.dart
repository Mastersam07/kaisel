...
final class _AddCardFlow extends _App implements KaiselModalRoute<bool> {
  const _AddCardFlow();
}

final class _VerifyIdentityFlow extends _App
...
class _CurrentStackParser extends RouteInformationParser<KaiselConfig<_App>> {
  _CurrentStackParser(this.router);
  final KaiselRouter<_App> router;

  @override
  Future<KaiselConfig<_App>> parseRouteInformation(
    RouteInformation routeInformation,
  ) async {
    return KaiselConfig<_App>(mainStack: router.stack);
  }
}
